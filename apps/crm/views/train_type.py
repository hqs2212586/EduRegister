...
from ..serializers.traintype_serializer import TrainTypeInfoSerializer, TrainTypeListSerializer
...
class TrainTypeInfoViewSet(ModelViewSet):
    ...
    #     if self.action == 'list':
    #         return TrainTypeInfoSerializer
    #     return TrainTypeInfoSerializer
...
class TrainTypeListView(ListAPIView):
    """学校列表视图"""
    queryset = TrainTypeInfo.objects.all()
    serializer_class = TrainTypeListSerializer
